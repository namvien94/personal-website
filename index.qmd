...
about:
  ...
  links:
    ...
    - text: Email
      ...
      icon: inbox-fill
    - text: Résume
      href: "https://docs.google.com/document/d/1AFEKfJco7e18QmHCoHdxoJ3P5LBWwavfWBhSnGT2Ygc/edit?usp=sharing"
      icon: file-text-fill
...
Bachelor of Science in [Statistics and Data Science](CeD.25EN-HAQQ-NQNQ.pdf){target="_blank"} \
Minor in [Digital Humanities](https://dh.ucla.edu/undergraduate-minor/){target="_blank"} \
...
Evaluation Assistant \| [UCLA Undergraduate Admission](https://admission.ucla.edu/contact){target="_blank"} \| February 2024 - September 2025
...
[DEEPenn STEM Scholar](https://web.sas.upenn.edu/deepennstem/deepenn-stem-weekend-2024/){target="_blank"} \| University of Pennsylvania \
